...
void Gnd_INIT(void)
{
	...
	Gnd.MapRegistLines = new autoList<char *>();
...
void Gnd_FNLZ(void)
{
	...
	releaseList(Gnd.MapRegistLines, (void (*)(char *))memFree);
...
#define SAVEDATA_SIGNATURE "Claris_SaveData " __DATE__ " " __TIME__
...
void ImportSaveData(void)
{
	...
	Gnd.FastBtnReverseMode = SD_ReadBoolean();
	SD_ReadLines(Gnd.MapRegistLines);
...
void ExportSaveData(void)
{
	...
	SD_WriteInt(Gnd.FastBtnReverseMode);
	SD_WriteLines(Gnd.MapRegistLines);
